...
{
    'name': "Section Subtotal (Community)",
    'version': '1.0',
    ...
    'assets': {
        'web.assets_backend': [
            'aspl_section_sub_total/static/src/js/list_renderer.js',
            'aspl_section_sub_total/static/src/js/section_and_note_fields_backend.js',
        ],
    },
    'installable': True,
    'auto_install': False,
